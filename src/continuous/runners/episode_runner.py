...
class EpisodeRunner:
    ...
    def run(self, test_mode=False, **kwargs):
        ...
        save_log_probs = getattr(self.args, "save_log_probs", False)
        while not terminated:
            ...
            if save_log_probs:
                actions, log_probs = self.mac.select_actions(
            ...
            if save_log_probs:
                post_transition_data["log_probs"] = log_probs.to("cpu")
        ...
        self.batch.update({"log_probs": log_probs}, ts=self.t)
